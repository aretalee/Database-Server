...
public class CopyOfConditionHandler {
    ...
    public List<Integer> filterTable(Table chosenTable, List<String> conditions, QueryHandler queryHandler) {
        ...
        return notEnoughParameters(combineResults(resultList), queryHandler);
    }

    public List<Integer> notEnoughParameters(List<Integer> combinedList, QueryHandler queryHandler) {
